...
> ⏱️ Temps total de développement : {{TIME}}
...
- Solution Part 1 TS : `ts/day{{DAY_PADDED}}/part1.ts`
- Solution Part 2 TS : `ts/day{{DAY_PADDED}}/part2.ts`
- Solution Part 1 C : `c/day{{DAY_PADDED}}/part1.c`
- Solution Part 2 C : `c/day{{DAY_PADDED}}/part2.c`
