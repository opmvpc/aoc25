...
<template>
  <UApp>
    <div class="min-h-screen flex flex-col">
      ...
      <header class="sticky top-0 z-50 glass border-b border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-14 sm:h-16 lg:h-18">
            ...
            <NuxtLink to="/" class="flex items-center gap-2 lg:gap-3 group shrink-0">
              <div class="relative">
                <span class="text-2xl sm:text-3xl lg:text-4xl transition-transform group-hover:scale-110 inline-block">🎄</span>
              ...
              <div class="hidden sm:block">
                <h1 class="text-base lg:text-xl font-bold bg-gradient-to-r from-yellow-400 via-yellow-200 to-yellow-400 bg-clip-text text-transparent whitespace-nowrap">
            ...
            <nav class="hidden md:flex items-center">
              <div class="flex items-center gap-1 glass-subtle px-1.5 py-1 rounded-xl">
                <NuxtLink
            ...
            <div class="flex items-center gap-2 sm:gap-3">
              ...
              <div class="hidden sm:flex items-center gap-2 glass-subtle px-2.5 py-1.5 rounded-lg">
                <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                <span class="text-xs lg:text-sm text-white/70">Live</span>
              </div>
              
              <!-- Stars counter - toujours visible -->
              <div class="flex items-center gap-1.5 glass-subtle px-2.5 sm:px-3 py-1.5 rounded-lg">
                <span class="star-gold text-base sm:text-lg lg:text-xl">★</span>
                <span class="text-yellow-400 font-bold text-xs sm:text-sm">0</span>
      ...
      <!-- Main content -->
      <main class="main-content max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 flex-1">
        <NuxtPage />
      </main>

      <!-- Footer - visible sur tablette et desktop -->
      <footer class="hidden sm:block border-t border-white/5 py-4 lg:py-6 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between text-xs lg:text-sm text-white/40">
            <p class="flex items-center gap-2">
              <span>🏆</span>
              <span class="hidden lg:inline">Advent of Code 2025 Battle Royale</span>
            ...
            <div class="flex items-center gap-4 lg:gap-6">
              ...
              >
                <UIcon name="i-simple-icons-github" class="w-4 h-4 lg:w-5 lg:h-5" />
              </a>
            </div>
          </div>
        </div>
