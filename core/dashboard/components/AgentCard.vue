...
<template>
  ...
  >
    ...
    <div 
      ...
      :class="{
        'bg-gradient-to-br from-yellow-400 to-yellow-600 shadow-lg shadow-yellow-500/50': rank === 1,
        'bg-gradient-to-br from-gray-300 to-gray-500 shadow-lg shadow-gray-400/30': rank === 2,
        'bg-gradient-to-br from-amber-600 to-amber-800 shadow-lg shadow-amber-600/30': rank === 3,
      }"
    >
      {{ rankEmoji }}
    </div>
